            ...
            <div className="main_content">
                ...
                {/* <div className="info"> */}
                    <div className="jumbotron">
                        <h1 className="display-4">Hi, I'm Kaiisha</h1>
                        <p className="lead">Front-End Web Developer with a degree in Marketing and experience providing exceptional Customer Service allows me to understand the balance of both visual appeal and conceptual functionality.</p>
